...
<table class="table table-bordered" id="myTable">
 ...
 ?>
     <tr>
	    ...
	    <td align="center">
            <a class="btn btn-warning" href="?page=gejala&action=update&idgejala=<?php echo $row['idgejala']; ?>">
            <i class='fas fa-edit'></i>
            </a>
            <a onclick="return confirm('Yakin menghapus data ini ?')" class="btn btn-danger" href="?page=gejala&action=hapus&idgejala=<?php echo $row['idgejala']; ?>">
