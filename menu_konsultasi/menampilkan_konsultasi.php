...
if (isset($_POST['proses'])) {
    ...
    // mengambil data dari tabel penyakit untuk memvalidasi di basis aturan
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // mencari penyakit jumlah gejala dibasis aturan berdasarkan penyakit
    ...
    <div class="col-sm-12">
        <form action="" method="POST" name="Form" onsubmit="return validasiForm()">
            <div class="card border-dark">
                <div class="card">
                    <div class="card-header bg-primary text-white border-dark"><strong>Konsultasi Penyakit Kulit</strong></div>
                    <div class="card-body">
